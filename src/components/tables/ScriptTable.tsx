...
const ScriptTable: React.FC<ScriptTableProps> = ({ data, onDataChange }) => {
  ...
  const openDialog = (item?: ScriptItem) => {
    if (item) {
      ...
      setFormData({
        ...
        penangananKasus: item.penangananKasus,
        undanganEksternal: item.undanganEksternal,
        rapatInternal: item.rapatInternal,
        persuratanParaf: item.persuratanParaf,
        ...existingDetails
      });
    } else {
      setCurrentItem(null);
  ...
  const handleSubmit = () => {
    ...
    const itemToSave: ScriptItem = {
      ...
      penangananKasus: formData.penangananKasus,
      undanganEksternal: formData.undanganEksternal,
      rapatInternal: formData.rapatInternal,
      persuratanParaf: formData.persuratanParaf
    };
                ...
                data.map((item) => (
                  <TableRow key={item.id}>
                    ...
                    <TableCell className="text-center border-l">
                      {item.penangananKasus ? '✅' : '❌'}
                    </TableCell>
                    <TableCell className="text-center">
                      {item.undanganEksternal ? '✅' : '❌'}
                    </TableCell>
                    <TableCell className="text-center">
                      {item.rapatInternal ? '✅' : '❌'}
                    </TableCell>
                    <TableCell className="text-center">
                      {item.persuratanParaf ? '✅' : '❌'}
                    </TableCell>
                    <TableCell>
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="border p-4 rounded-md">
                <div className="flex items-center mb-3">
                  <Checkbox 
                    id="penangananKasus"
                    checked={formData.penangananKasus}
                    onCheckedChange={(checked) => handleCheckboxChange('penangananKasus', checked as boolean)}
                    className="mr-2"
                  />
                  <label htmlFor="penangananKasus" className="font-medium">Penanganan Kasus</label>
                </div>
                <Textarea 
                  ...
                  disabled={!formData.penangananKasus}
                />
              </div>
              ...
              <div className="border p-4 rounded-md">
                <div className="flex items-center mb-3">
                  <Checkbox 
                    id="undanganEksternal"
                    checked={formData.undanganEksternal}
                    onCheckedChange={(checked) => handleCheckboxChange('undanganEksternal', checked as boolean)}
                    className="mr-2"
                  />
                  <label htmlFor="undanganEksternal" className="font-medium">Undangan Eksternal / Arahan Pimpinan</label>
                </div>
                <Textarea 
                  ...
                  onChange={handleTextareaChange}
                  disabled={!formData.undanganEksternal}
                />
              </div>
              ...
              <div className="border p-4 rounded-md">
                <div className="flex items-center mb-3">
                  <Checkbox 
                    id="rapatInternal"
                    checked={formData.rapatInternal}
                    onCheckedChange={(checked) => handleCheckboxChange('rapatInternal', checked as boolean)}
                    className="mr-2"
                  />
                  <label htmlFor="rapatInternal" className="font-medium">Rapat Internal</label>
                </div>
                <Textarea 
                  ...
                  onChange={handleTextareaChange}
                  disabled={!formData.rapatInternal}
                />
              </div>
              ...
              <div className="border p-4 rounded-md">
                <div className="flex items-center mb-3">
                  <Checkbox 
                    id="persuratanParaf"
                    checked={formData.persuratanParaf}
                    onCheckedChange={(checked) => handleCheckboxChange('persuratanParaf', checked as boolean)}
                    className="mr-2"
                  />
                  <label htmlFor="persuratanParaf" className="font-medium">Persuratan Paraf Koordinasi</label>
                </div>
                <Textarea 
                  ...
                  onChange={handleTextareaChange}
                  disabled={!formData.persuratanParaf}
                />
              </div>
            </div>
          </div>
